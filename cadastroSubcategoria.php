...
<head>
    ...
    <title>FMS Suporte - Cadastro Subcategoria</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Cadastro de Subcategoria
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <form id="formulario" name="formulario" method="POST" action="dao/cadSubcategorias.php"
                        autocomplete="off">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <input id="inputCategoria" name="categoria" class="form-control" type="text"
