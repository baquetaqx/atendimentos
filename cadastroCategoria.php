...
<head>
    ...
    <title>FMS Suporte - Cadastro Categoria</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Cadastro de Categoria
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <form id="formulario" name="formulario" method="POST" action="dao/cadCategoria.php"
                        autocomplete="off">
