...
<head>
    ...
    <title>FMS Suporte - Cadastro Produto</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Cadastro Produto
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <form id="formulario" name="formulario" method="POST" action="dao/cadProduto.php"
                        autocomplete="off">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label>Preço:</label>
                                <input type="text" id="preco" class="form-control" name="preco" required="required" autofocus="autofocus" size="12" onKeyUp="maskIt(this,event,'###.###.###,##',true)">
                            </div>
                        </div>
