...
<head>
    ...
    <title>FMS Suporte - Cadastro Usuário</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Cadastro de Usuário
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <form id="formulario" name="formulario" method="POST" action="dao/cadUsuario.php"
                        autocomplete="off">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="funcao">
                                    ...
                                    <option value="3">Analista Suporte</option>
                                </select>
                            </div>
                        </div>
